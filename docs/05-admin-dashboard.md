...
2. Implementar consultas agregadas:
    ...
    - Eventos agrupados por status (Aberto/Finalizado).
    - **Taxa de Engajamento:** (Participantes com lista de desejos preenchida / Total de participantes).
    - Volume de mensagens trafegadas nas últimas 24h.
